...
# docker_run python -um "ngen_rte.run_forecast" -dt "2025-07-13 12:00:00" -rname "${fcst_run_name}_short" -fconfig short_range -rfc /ngwpc/run_ngen/data/reservoir_rfc_da/
