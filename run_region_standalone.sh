...
# USGS Streamflow DA
docker_run python -um "ngen_rte.run_regionalization_standalone" -n 2 -faf "${TEST_FORM_ASSIGN_VPU}" -cgf "${TEST_CAT_GRP_VPU}" -fconfig "short_range" -dt "2026-07-13 12:00:00" -rname "region_sr" -usgs /ngwpc/run_ngen/data/usgs_timeslice/ -v "03S"
