...
# docker_run "/ngen-app/bin/bin_mounted/run_tests.py" --quit_forecast_after_duration 10
...
# docker_run "/ngen-app/bin/bin_mounted/run_tests.py" --do_all_forcing_configs --quit_forecast_after_duration 10
# docker_run "/ngen-app/bin/bin_mounted/run_tests.py" --do_calibration --do_coldstart --do_all_forcing_configs
# docker_run "/ngen-app/bin/bin_mounted/run_tests.py" --do_calibration --skip_forecast
# docker_run "/ngen-app/bin/bin_mounted/run_tests.py" --do_coldstart --skip_forecast
