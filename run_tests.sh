...
# docker_run python -um "ngen_rte.tests.run_tests" --do_calibration --skip_forecast --nprocs 2 --fcst_run_name "${fcst_run_name}" --gage_id 01123000 --hydrofab_file "${TEST_HYDROFAB_FILE}"
