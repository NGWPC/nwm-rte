...
# 5 Short Range
docker_run python -um "ngen_rte.run_default" -n 2 -fconfig "short_range" -dt "2023-12-17 00:00:00" -rname "default_sr_-2d" --load_state_from /ngwpc/run_ngen/default/default_ana_7day/01/state_save/ -v "01" --output_format NetCDF
docker_run python -um "ngen_rte.run_default" -n 2 -fconfig "short_range" -dt "2023-12-18 00:00:00" -rname "default_sr_-1d" --load_state_from /ngwpc/run_ngen/default/default_ana_-2d_-1d/01/state_save/ -v "01" --output_format NetCDF
docker_run python -um "ngen_rte.run_default" -n 2 -fconfig "short_range" -dt "2023-12-19 00:00:00" -rname "default_sr_0d" --load_state_from /ngwpc/run_ngen/default/default_ana_-1d_0d/01/state_save/ -v "01" --output_format NetCDF
docker_run python -um "ngen_rte.run_default" -n 2 -fconfig "short_range" -dt "2023-12-20 00:00:00" -rname "default_sr_1d" --load_state_from /ngwpc/run_ngen/default/default_ana_0d_1d/01/state_save/ -v "01" --output_format NetCDF
docker_run python -um "ngen_rte.run_default" -n 2 -fconfig "short_range" -dt "2023-12-21 00:00:00" -rname "default_sr_2d" --load_state_from /ngwpc/run_ngen/default/default_ana_1d_2d/01/state_save/ -v "01" --output_format NetCDF
