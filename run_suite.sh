...
docker_run python "/ngen-app/bin/bin_mounted/run_calibration.py" -n 2 -fsrc "nwm" -gdomain "Puerto_Rico" --gage_id "50027000" -start "2017-09-20 00:00:00" -dur 4

# Hawaii sample calibration during Tropical Storm Fabio
# sudo rm -rf ~/ngwpc/run_ngen/kge_dds/test_bmi/16060000
docker_run python "/ngen-app/bin/bin_mounted/run_calibration.py" -n 2 -fsrc "nwm" -gdomain "Hawaii" --gage_id "16060000" -start "2006-08-06 00:00:00" -dur 2

# Alaksa sample calibration 
# sudo rm -rf ~/ngwpc/run_ngen/kge_dds/test_bmi/15209700
docker_run python "/ngen-app/bin/bin_mounted/run_calibration.py" -n 2 -fsrc "nwm" -gdomain "Alaska" --gage_id "15209700" -start "2016-07-25 00:00:00" -dur 2
