...
EVAL_VERF_PYTHON_ALIAS = "python_eval_verf"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval", dest="run_eval")  # eval is a python keyword so dest should be something else
