...
FORCING_TEMPLATE_DIR = f"{site.getsitepackages()[0]}/NextGen_Forcings_Engine_BMI/BMI_NextGen_Configs/config_templates/"
...
MODULE_PARAMETER_FILES_DIR = f"{site.getsitepackages()[0]}/mswm/module_parameter_files"
